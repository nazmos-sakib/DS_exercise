...
public class NounProducer{ private final String[] nouns = {"dog", "cat", "mouse", "elephant", "tiger"};
    private final int numberOfElements;private final String queueName;
    public NounProducer(int numberOfElements, String queueName) {
    ...
    public void send() {
        ...
        try {
            ...
            for (int i = 0; i < numberOfElements; i++) {
                ...
                TextMessage msg = session.createTextMessage(nouns[index]);
                producer.send(msg);
            }
